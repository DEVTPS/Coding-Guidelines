...
## Что такое DDD?  
Domain Draiven Design - подход к разработке ПО, ориентированный на объектную модель предметной области. Прежде чем приступать к разработке ПМ, необходимо понять, какие объекты будут участвовать в рамках бизнесс-процессов, которые будут автоматизироваться с помощью нового ПМ.
